...
window.webcam = {
	...
	get_html: function(width, height, server_width, server_height) {
		...
		if (this.ie) {
			...
			html += '<embed id="webcam_movie" src="'+this.swf_url+'" wmode="transparent" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" />';
		}
	...
	flash_notify: function(type, msg) {
		...
		switch (type) {
			...
			case 'activity':
				// camera is turned on and started to take pictures, execute user callback function
				// and pass raw API script results to function
				this.fire_hook('onActivity');
				break;
